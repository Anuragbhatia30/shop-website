            ...
            >
              ...
              <div className="flex flex-col items-center gap-3 mt-4">
                <button
                  type="button"
                  disabled={true}
                  className="w-full bg-slate-300 text-slate-500 px-8 py-4 rounded-xl font-bold text-lg cursor-not-allowed transition-all flex items-center justify-center gap-3"
                >
                  Send Message <Send className="w-5 h-5 opacity-50" />
                </button>
                <div className="text-sm font-semibold text-amber-700 bg-amber-50 border border-amber-200 px-4 py-2 rounded-lg flex items-center justify-center w-full shadow-sm">
